...
import { DELIVERY_IMAGE } from "./shared";

export function State05Delivered() {
  const [showRate, setShowRate] = useState(false);

  useEffect(() => {
    const timer = window.setTimeout(() => setShowRate(true), 2000);
  ...
  return (
    <div className="grid items-center gap-6 md:grid-cols-2 md:gap-8">
      <div className="flex flex-col items-center text-center md:items-start md:text-left">
        ...
        >
          Landed · Cleared customs · Out for delivery
        </m.p>
        {showRate ? (
          <m.p
      ...
      >
        ...
        <div className="relative aspect-[4/3] overflow-hidden rounded-xl border border-emerald-500/30 shadow-[0_20px_60px_-24px_rgba(0,0,0,0.9),0_0_0_1px_rgba(255,255,255,0.08)] ring-1 ring-white/10">
          <Image
            src={DELIVERY_IMAGE}
            alt="Nissan Skyline R34 at Oishi Park, Japan"
            fill
