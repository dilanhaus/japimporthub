...
type Phase = "filling" | "ready" | "pressing" | "sent";
...
export function State01PostRequest() {
  ...
  useEffect(() => {
    ...
    const allFieldsAt = 80 + (REQUEST_FIELDS.length - 1) * FIELD_DELAY_MS + 200;
    timers.push(window.setTimeout(() => setPhase("ready"), allFieldsAt));
    timers.push(window.setTimeout(() => setPhase("pressing"), allFieldsAt + 500));
    timers.push(window.setTimeout(() => setPhase("sent"), allFieldsAt + 850));
