...
import { WHATSAPP_NOTIFICATION } from "./shared";

type WhatsAppNotificationProps = {
  visible: boolean;
};

export function WhatsAppNotification({ visible }: WhatsAppNotificationProps) {
  return (
    <AnimatePresence>
      {visible ? (
        <m.div
        ...
        >
          <div className="flex gap-2.5">
            <div
              className="flex size-9 shrink-0 items-center justify-center rounded-full bg-[#25D366]"
              aria-hidden
            >
